...
export default function Images({ pass, images }) {
    ...
    const uploadDocument = async () => {
        ...
        const res = await api(`/api/modules/product-pass/passImages`, {
            method: 'POST',
            body: {
                data: {
                            ...
                            <div className="flex justify-center w-full">
                                {!submit ?
                                    ...
                                    <Button className="bg-red-600 text-white">
                                        <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export async function getServerSideProps(ctx) {
    ...
    const images = pass.pp_productImages
    return {
        props: {
