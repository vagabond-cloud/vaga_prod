            ...
            <Card>
              ...
              <Card.Footer>
                {data ? (
                  ...
                  <Link
                    href="/auth/login"
                    className="flex items-center justify-center px-5 py-2 space-x-3 text-white bg-red-600 rounded hover:bg-red-500"
                  >
                    Create an account
                  </Link>
                )}
...
export const getServerSideProps = async (context) => {
  ...
  return { props: { workspace: JSON.stringify(workspace) } };
};
