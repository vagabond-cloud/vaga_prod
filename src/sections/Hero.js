      ...
      <div className="relative flex flex-col px-10 mx-auto space-y-5 md:w-3/4">
        <header className="flex items-center justify-between space-x-3">
          ...
          >
            ...
            <Link
              ...
              className="w-full px-5 py-2 text-center text-white bg-red-600 rounded shadow hover:bg-red-500"
            >
        ...
        <div className="flex flex-col items-center justify-center pt-10 mx-auto md:w-3/5">
          <h1 className="text-6xl font-extrabold text-center">
            <span className="block">Build Business apps </span>
            <span className="block text-red-600">like never before</span>
          </h1>
          <p className="mt-5 text-center text-gray-600">
            Quickly build for fast results
          </p>
        </div>
        <div className="flex items-center justify-center space-x-5">
          <a className="px-10 py-3 text-center text-white bg-red-600 rounded shadow hover:bg-red-500">
            Get Started
          </a>
        </div>
      </div>
